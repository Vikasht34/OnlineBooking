...
GO
PRINT N'The following operation was generated from a refactoring log file 0f1b0a46-01e3-40d9-9458-5f4c74db6590';

PRINT N'Rename [dbo].[User].[Name] to FirstName';


GO
EXECUTE sp_rename @objname = N'[dbo].[User].[Name]', @newname = N'FirstName', @objtype = N'COLUMN';
...
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '0f1b0a46-01e3-40d9-9458-5f4c74db6590')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('0f1b0a46-01e3-40d9-9458-5f4c74db6590')
